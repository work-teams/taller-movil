...
describe('getAllServices', () => {
    ...
    it('should return an array of services with their corresponding IDs when given a valid array of IDs', () => {
        ...
        const expectedServices = [
            [{ serviceId: 0, name: 'Cruz del Sur', photo_url: 'https://images.ctfassets.net/1nvpgv2kdfc0/1kqJ26hOIgs5ltRX21DURK/8764ce9a5c4f943c1006795ea2dac0bf/Cruz_del_Sur_bus.png' }, 'id1'],
            [{ serviceId: 1, name: 'LATAM Perú', photo_url: 'https://elcomercio.pe/resizer/0WL_qDGXSvtMc2ecM2xy62ZSEbM=/1200x800/smart/filters:format(jpeg):quality(75)/arc-anglerfish-arc2-prod-elcomercio.s3.amazonaws.com/public/F33LKLQJBRHQREI2QPZWM3M6NQ.jpg' }, 'id2']
        ];
